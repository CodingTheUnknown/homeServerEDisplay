...
try: 
    ...
    draw.text((Screen.width_lower.value + 3, 85), "0.0.0.0:00", font=font12, fill=0)
    ...
    draw.text((Screen.width_center.value + 5, 85), "0.0.0.0:00", font=font12, fill=0)
    ...
    draw.text((Screen.width_lower.value + 3, 129), "0.0.0.0:00", font=font12, fill=0)
    ...
    draw.text((Screen.width_center.value + 5, 129), "0.0.0.0:00", font=font12, fill=0)
    ...
    draw.text((Screen.width_lower.value + 10, 216), 'Pressure: ---- hPa', font=font14, fill=0)
